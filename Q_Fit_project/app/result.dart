...
class _ResultPageState extends State<ResultPage> {
  ...
  Future<Map<String, dynamic>> fetchImageUrls(String imagePrefix) async {
    try {
      var apiBaseUrl =
          'https://22f0-112-172-64-10.ngrok-free.app/image_info/'; // FastAPI 서버 주소
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/bg_color.png'), // 백그라운드 이미지 설정
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              ...
                              image: frontViewImage.isNotEmpty
                                  ...
                                  : AssetImage('assets/images/jellyfish.png')
                    ...
                    Expanded(
                      ...
                      child: Center(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              //파워 게이지 이미지 (width: 250, height: 318)
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: bestShotImage.isNotEmpty
                            ...
                            : AssetImage(
                                'assets/images/with_ball.png'), // 임시 이미지
                        fit: BoxFit.scaleDown, // BoxFit을 사용하여 이미지를 맞춤
                      ),
                    ),
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Image.asset('assets/images/icon/back_icon.png',
                width: 40, height: 40),
          ),
          ...
          GestureDetector(
            ...
            child: Image.asset('assets/images/icon/home_icon.png',
                width: 40, height: 40),
          ),
          const SizedBox(height: 0),
        ],
